...
export const Landing = () => {
  ...
  return (
    <PublicLayout>
      ...
      <ContentSection sectionTitle="Discover your perfect match" description="Find unique goods and services tailored just for you" label="Explore" containerClasses="px-8 md:px-24 py-10" descriptionStyle="md:w-2/3" click={()=> navigate('/explore')} hero />
      <Features />
