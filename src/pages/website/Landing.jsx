  ...
  return (
    <PublicLayout>
      ...
      >
        ...
        <Features />
        <ContentSection
          sectionTitle="Build your digital storefront in minutes."
          description="Stock up your catalog and become visible to promising customers that need your goods and services."
          descriptionStyle="md:w-2/3"
          label="Start"
        ...
        <ContentSection
          ...
          description="With the use of Geolocation features, gain access to even the most rural markets wherever you are."
          descriptionStyle="md:w-2/3"
          label="Explore"
          containerClasses="px-10 md:px-32 py-10"
          hero={false}
