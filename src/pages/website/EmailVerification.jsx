...
export const EmailVerification = () => {
  ...
  return (
    <PublicLayout>
      <motion.div className="relative w-full max-w-md bg-white md:rounded-lg shadow-md p-8 text-error h-60 justify-center items-center text-center flex flex-col my-32"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
